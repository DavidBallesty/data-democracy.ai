"""
Django settings for democratize project.
...
SECRET_KEY = 'django-insecure-j+pqkkteq3-2&%19%_td2(ef_0o!fe0#$d85_9qj4-@zf883=+'
...
#        'APP_DIRS': True,
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # Adjust the path accordingly
        'APP_DIRS': True,        
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'democratize.wsgi.application'
